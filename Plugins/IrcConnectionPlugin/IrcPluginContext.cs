...
namespace TwoWholeWorms.Lumbricus.Plugins.IrcConnectionPlugin
{
    ...
    class IrcPluginContext : DbContext
    {

        readonly static Logger logger = LogManager.GetCurrentClassLogger();

        public static IrcPluginContext db;
        ...
        {
            if (db == null) {
                logger.Info("Initialising IrcConnectionPlugin database context");
                db = new IrcPluginContext();
            } else {
                logger.Info("Skipping IrcConnectionPlugin database context initialisation; already done");
            }
        }
